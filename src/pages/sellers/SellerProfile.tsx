    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-900">Sotuvchi profili</h1>
          <button
            onClick={() => navigate(-1)}
        ...
        <div className="bg-white rounded-lg shadow mb-6">
          <div className="flex flex-col justify-between items-start pb-3 mb-4">
            <div className="w-full py-8 px-6 rounded-t-lg bg-[linear-gradient(to_bottom,_#d97706_50%,_white_50%)]">
              <div className="flex flex-row items-end justify-between mt-8 pb-8 border-b-2 border-b-gray-300">
                <div className="flex flex-row items-end justify-between">
                  <div className="w-40 h-40 rounded-lg border-4 border-white overflow-hidden">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
        </div>
      </div>
    </div>
  );
